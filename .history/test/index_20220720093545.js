...
const { appKey, appSecret, accessTokenCache, userTax, okCode: code, redirectUri } = nuonuo.config;
...
nuonuo.getIsvToken(appKey, appSecret, code, userTax, redirectUri, 'client_credentials').then(res => console.log({ getIsvToken: res }));

// const runTest = async () => {
//   const tokenResponse = await nuonuo.getIsvToken(appKey, appSecret);
